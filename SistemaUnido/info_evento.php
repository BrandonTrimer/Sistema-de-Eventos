<!DOCTYPE html>
<!-- saved from url=(0057)https://5dd49506d2def.site123.me/lineup/bass-drop-dj-crew -->
<html dir="ltr" lang="es"
	class=" inside_page inside_page_header_design s_layout13 isFreePackage  js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface no-generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths">
...
<head>
	...
	<!-- Minimize CSS files -->
	<link rel="stylesheet" href="TiCkeT_files/css/minimize.css" type="text/css"
		crossorigin="anonymous">
	<link rel="stylesheet" href="TiCkeT_files/css/websiteCSS.css" class="reloadable-css"
		type="text/css"> <!-- Froala Editor CSS -->
...
<body id="page-top" data-aos-easing="ease" data-aos-duration="200" data-aos-delay="0">
	<div class="body">
		...
		<nav id="mainNavMobile" class="navbar-fixed-top" style="opacity: 1;">
			...
			<div class="navbar-header"> <a class="navbar-brand page-unique logo_name  weight700 "
					href="TiCkeT.html"> <span class="website-name">TiCkeT</span> </a> </div>
			<div class="navPagesRight">
				<ul class="navActions nav navbar-nav">
					...
					<li class="header-cart-wrapper orderOpenCart show-static"><a
							class="actionButton btn-primary-action-button-4" role="button"><i
								class="fa fa-shopping-cart"><span class="count" style="display: none;"></span></i></a>
					</li>
				</ul>
			</div>
		</nav>
						...
						<div class="row product-container">
							...
							<div class="col-xs-12 col-sm-5 product-details">
								...
								<div class="product-images">
									<!-- Main Image -->
									<div class="main-image" style="height: 305px;"> <img class="hideImageRatio"
											src="TiCkeT_files/img/800_filter_boost_5ac9f86e32c91.jpg"
							...
							<style>
							.container .mainOrderBox {position: relative;
								  top: 100px;
									left: 200px;
									  width: 1000px;}
							...
							<div class="container mainOrderBox">
									<div class="box" >
										...
										<div class="row">
											<div class="col-xs-12 col-sm-7 order-spacing-box">
												<div class="row order-form-box" style="display: block;">
													<div class="col-xs-12 col-sm-9">
													<div id="mobile-responsive-container" class="hidden-sm">
														<div id="orderContainer">
															<br>
															
															<form id="order_form_detail "
																action="confirmar_datos.php"
																novalidate="novalidate" >
																<div class="row">
																		<div class="col-xs-12">
																				<div class="form-group softLabel"><input type="text" value=""
																						id="" name="phone_number" class="form-control valid"
																						required="" data-msg-required="Este campo es necesario"
																						aria-required="true" aria-invalid="false"></label></div>
																			</div>
																							
																</div> <!-- Subscribe -->
															
																<div class="SubmitButtonsArea form-actions"> <button type="submit"
