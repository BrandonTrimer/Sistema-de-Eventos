<!DOCTYPE html>
<!-- saved from url=(0132)https://5dd49506d2def.site123.me/?orderScreen=2&w=&websiteID=2821297&sessionID=5dd4a6630fa0c&orderID=5dd71bde9ff37&cartType=2&tranW= -->
<html dir="ltr" lang="es"
	class="cartOrdersPagesSSL inside_page inside_page_header_design s_layout13 isFreePackage  js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface no-generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths">

<head>

	<meta name="theme-color" content="#e95095"> <!-- Regular Meta Info -->
	<title class="s123-js-pjax">Pagar - TiCkeT</title>
	<meta name="description" content="TiCkeT" class="s123-js-pjax">
	<meta name="keywords" content="" class="s123-js-pjax">
	
	<script type="text/javascript" async="" src="TiCkeT_files/js/analytics.js.descarga"></script>
	<script async="" src="TiCkeT_files/js/js"></script>
	...
	<!-- Minimize CSS files -->
	<link rel="stylesheet" href="TiCkeT_files/css/minimize.css" type="text/css" crossorigin="anonymous">
	<link rel="stylesheet" href="TiCkeT_files/css/websiteCSS.css" class="reloadable-css" type="text/css">
	<!-- International Telephone Input CSS -->
	<link rel="stylesheet" href="TiCkeT_files/css/intlTelInput.css" crossorigin="anonymous">
	<!-- Froala Editor CSS -->
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">

</head>
<body id="page-top" data-aos-easing="ease" data-aos-duration="200" data-aos-delay="0">
		<div class="parallax-mirror" id="parallax_promo_mirror_5ac9ed6021624"
			style="visibility: hidden; z-index: -100; position: fixed; top: 624.2px; left: 0px; overflow: hidden; background-color: rgb(0, 0, 0); transform: translate3d(0px, 0px, 0px); height: 526px; width: 1519px;">
			<img class="parallax-slider" src="TiCkeT_files/img/2000_5ac9eda33c342.jpg"
				style="opacity: 0.7; filter: contrast(110%) brightness(110%) saturate(130%); transform: translate3d(0px, 0px, 0px); position: absolute; left: 0px; height: 1012px; width: 1519px; max-width: none; top: -633.36px;">
		</div>
				...
				<div class="navPagesRight">
					<ul class="navActions nav navbar-nav">
						<li class="header-address-wrapper"><a data-close-location="right" class="actionButton" role="button"
								data-container="body" data-toggle="address_menuCallActionIcons"><i
						...
						<li class="header-cart-wrapper orderOpenCart show-static"><a
								class="actionButton btn-primary-action-button-4" role="button"><i
									class="fa fa-shopping-cart"><span class="count" style="display: none;">
									</span>
								</i>
							</a>
						</li>
						...
						<div class="container">
							<div class="row modulesTitle">
								<div class="col-xs-12 text-center">
									<h1 id="section--title" class="s123-page-header">Datos Personales</h1>
									<hr class="small">
									...
									<div class="col-xs-12 col-sm-4 col-sm-offset-4">
										<div class="col-xs-12 payment-method-list border-primary">
											<div class="radio"> <label><span
														class="">INFORMACION PERSONAL</span> </label> 
											</div>
										</div>
										...
										<div class="text-center"> 
												<div class="text-center"> <a href="registro_completo.php" 
												class="place-order-btn btn btn-primary">Finalizar</a> </div>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="popover_address_icons">
				<div class="global-contact-details-container text-center">
					<ul class="list-unstyled">
						<li><a href="http://maps.google.com/?q=Cochabamba%2C+Departamento+de+Cochabamba%2C+Bolivia"
								target="_blank"><i class="fa fa-location-arrow"></i> Cochabamba, Departamento de
								Cochabamba, Bolivia</a></li>
					</ul>
				</div>
			</div>
			<div class="popover_icons">
				<div class="social-icons">
					<ul class="list-inline">
						<li><a href="https://maps.google.com/?q=Cochabamba%2C+Departamento+de+Cochabamba%2C+Bolivia"
								target="_blank"><img src="TiCkeT_files/img/google_map_white_small.png"
									style="width: 40px;height: auto;padding-bottom: 7px;"></a></li>
						<li><a href="https://waze.com/ul?ll=-17.4139766,-66.1653224&amp;navigate=yes"
								target="_blank"><img src="TiCkeT_files/img/waze_white_small.png"
									style="width: 40px;height: auto;padding-bottom: 7px;"></a></li>
						<li class="visible-xs-inline-block"><a
								href="moovit://directions?dest_lat=-17.4139766&amp;dest_lon=-66.1653224"
								target="_blank"><img src="TiCkeT_files/img/moovit_white_small.png"
									style="width: 40px;height: auto;padding-bottom: 7px;"></a></li>
						<li class="visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><a
								href="https://moovit.com/?to=Cochabamba%2C+Departamento+de+Cochabamba%2C+Bolivia&amp;tll=-17.4139766_-66.1653224&amp;metroId=1"
								target="_blank"><img src="TiCkeT_files/img/moovit_white_small.png"
									style="width: 40px;height: auto;padding-bottom: 7px;"></a></li>
					</ul>
				</div>
				...
				<div class="social-details-container social-icons">
					<ul class="list-inline">
						<li><a href="https://www.facebook.com/" target="_blank"><i
									class="fa fa-facebook fa-fw fa-4x"></i></a></li>
						<li><a href="https://www.youtube.com/" target="_blank"><i class="fa fa-youtube fa-4x"></i></a>
						</li>
					</ul>
				</div>
			</div>
		</div> <input type="hidden" id="facebook_url" name="facebook_url" value="https://www.facebook.com/"> <input
			type="hidden" id="twitter_url" name="twitter_url" value="">
	</div>
	<script>        var menuScrollOffset = 60;
			...
			var modulesList = "[{\"id\":\"283842226\",\"moduleID\":\"5ac9e99f21623\",\"moduleTypeNUM\":\"2\",\"title\":\"LINEUP\",\"settings\":\"\",\"url\":\"lineup\",\"style\":\"2\",\"modulesArrID\":\"2\",\"slogan\":\"\",\"showInMenu\":\"1\",\"showInFooter\":\"1\",\"mp_showInMenu\":\"1\",\"mp_showInHome\":\"1\",\"parentId\":null},{\"id\":\"283842227\",\"moduleID\":\"5ac9ed6021624\",\"moduleTypeNUM\":\"1000\",\"title\":\"Promo - Imagen\",\"settings\":\"\",\"url\":\"promo-image\",\"style\":\"21\",\"modulesArrID\":\"1017\",\"slogan\":\"\",\"showInMenu\":\"1\",\"showInFooter\":\"1\",\"mp_showInMenu\":\"1\",\"mp_showInHome\":\"1\",\"parentId\":null},{\"id\":\"283842229\",\"moduleID\":\"5ac9f29d7e7a0\",\"moduleTypeNUM\":\"16\",\"title\":\"About The Festival\",\"settings\":\"\",\"url\":\"about-the-festival\",\"style\":\"2\",\"modulesArrID\":\"34\",\"slogan\":\"\",\"showInMenu\":\"1\",\"showInFooter\":\"1\",\"mp_showInMenu\":\"1\",\"mp_showInHome\":\"1\",\"parentId\":null},{\"id\":\"283842232\",\"moduleID\":\"5ac9f45d7e7a3\",\"moduleTypeNUM\":\"7\",\"title\":\"Contacto\",\"settings\":\"\",\"url\":\"contact-us\",\"style\":\"5\",\"modulesArrID\":\"60\",\"slogan\":\"\",\"showInMenu\":\"1\",\"showInFooter\":\"1\",\"mp_showInMenu\":\"1\",\"mp_showInHome\":\"1\",\"parentId\":null}]";
	...
	<script>var translations = {
			...
			"limit20Tickets": "L\u00edmite de 20 entradas",
	...
	<!-- Minimize JS files -->
	<script src="TiCkeT_files/js/minimize.js.descarga" crossorigin="anonymous"></script>
	<!-- Website Statistics -->
	<script type="text/javascript" src="TiCkeT_files/js/generateStats.js.descarga"
		crossorigin="anonymous"></script>
	<script>//Run when the page load (before images and other resource)
		jQuery(function ($) {

			// Get object
			var $radioButtons = $('[type=radio][name=payment_method]');
			var $paymentMethods = $('.payment-method-list');

			// Click event that call to the correct payment method
			$('.place-order-btn').click(function () {
				// get the checked radio button
				var checked = $('input[type=radio]:checked');
				// check if there checked radio button
				if (checked.length > 0) {
					// get object
					var $radioButton = $(checked.get(0));
					// get the payment method selector
					var value = $radioButton.attr('value');
					// check if it's a offline payment method and add the payment method type hidden field to the form
					var offlineType = $radioButton.data('offline-type');
					var displayName = $radioButton.data('display-name');
					if (value == '.offline-payment-pay-btn') {
						// add payment method type hidden field to the form
						$('.offline-payment-form').find('.offlineType').val(offlineType);
						$('.offline-payment-form [name=sgp]').val($('.offline-payment-form [name=sgp]').val() + ' - ' + displayName);
					}
					// display the loading
					orderLoadingMessage.show();
					/**
					 * Observe DOM Changes - We show a loading message while the credit 
					 * card gateway is loaded, but we don't know when the gateway really 
					 * finished, so we observe the DOM to detect that and remove the loading.
					 */
					Orders_MutationObserverHandler.init('body');
					Orders_MutationObserverHandler.start(function () {
						// hide the loading message
						orderLoadingMessage.hide();
						// stop observe	
						Orders_MutationObserverHandler.stop();
					});
					// payment method initialize
					if ($radioButton.data('callback')) {
						// call to a callback function to initialize the payment method
						eval($radioButton.data('callback')).call(this);
					} else {
						// trigger click to initialize the payment method
						$(value).click();
					}
				}
			});
			...
			$radioButtons.first().prop('checked', 'true').closest('.payment-method-list').addClass('border-primary').find('.payment-method-description').show();

			// Active the correct payment method by change the radio button
			$radioButtons.change(function () {
				// get object
				var $radioButton = $(this);
				var $paymentMethod = $radioButton.closest('.payment-method-list');
				var $description = $paymentMethod.find('.payment-method-description');
				// initialize the all payment methods (by removing the active border and the description from all them)
				$radioButtons.closest('.payment-method-list').removeClass('border-primary');
				$radioButtons.closest('.payment-method-list').find('.payment-method-description').slideUp(350);
				// add active border to the checked radio button
				if ($radioButton.prop('checked')) {
					// set active border
					$(this).closest('.payment-method-list').addClass('border-primary');
					// display payment method description if it's exit
					$description.slideDown(350);
				}
			});

			// Prevent from change radio button status by click on the radio button label because the parent div is clickable
			$radioButtons.click(function (e) {
				e.stopPropagation();
			});

			// Set click on the parent div of the radio button
		...
		/**
		 * The function show and hide the order loading message.
		 */
		var orderLoadingMessage = new function () {

			//Get loading container
			var container = $('.mainOrderBox .box');

			//Set the loading design template
			var template = '<div id="orderLoadingMessage"><i class="ace-icon fa fa-spinner fa-spin white fa-5x"></i></div>';
		...
		/**
		 * The object make actions related to DOM changes, to do it we use the
		 * browser Mutation Observer object. I build it only for the orders now
		 * because we don't need it at any other places, but if we will use it
		 * we just need to change the object name to `MutationObserverHandler`
		 * copy it to the main scripts and use it. Note: May be the observe 
		 * options object will need to be sent also to customize it. 
		 */
		var Orders_MutationObserverHandler = new function () {
			// set objects 
			...
			/**
			 * The function start observe the element.
			 */
			this.start = function (callback) {
				// exit - browser doesn't support mutation observer / element doesn't exist
				if (!MutationObserver || $element.length === 0) return;
				// prevent multiple instances - we stop observing in case we already observe that element
				this.stop();
				// create an observer instance
				observer = new MutationObserver(callback);
				// start observe element
				observer.observe($element.get(0), {
					childList: true,	// observed additions and removals of the target child elements
					subtree: true,		// observed target and target's descendants
				});
			};
			/**
			 * The function stop observe the element.
			 */
			this.stop = function () {
