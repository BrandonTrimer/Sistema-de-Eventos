<!DOCTYPE html>
<!-- saved from url=(0115)https://5dd49506d2def.site123.me/?orderScreen=3&w=&websiteID=2821297&orderID=5dd71bde9ff37&tranW=&offlineType=phone -->
<html dir="ltr" lang="es"
						...
						<div class="container">
							<div class="row modulesTitle">
								<div class="col-xs-12 text-center">
									<h1 id="section--title" class="s123-page-header">Registro Completo</h1>
									<hr class="small">
								...
								<div id="orderContainer">
									<div class="text-center charged-successfully">
										...
										<div class="row">
											...
											<p class="text-left"> <b>Correo Electronico</b><a href="#" style="direction: ltr;">  <br> kevin@upds.com.bo</a> </p>
											...
											<div style="float: right; padding-top : 13%" ><img src="TiCkeT_files/img/ima.jpg" alt=""></div>
										...
										<!-- Buttons  --> <a style="margin-top: 60px;" href="index.php"
	...
	<script type="text/javascript" src="TiCkeT_files/js/generateStats.js.descarga"
		crossorigin="anonymous"></script> <!-- Pjax Helper -->
