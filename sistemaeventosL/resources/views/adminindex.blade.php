        ...
        <div class="container-fluid text-white">
            ...
            <div class="row">
                <ul class="nav responsive-tab nav-material nav-material-white">
                    <li>
                        <a class="nav-link active" href="adminindex.php"><i class="icon icon-list"></i>Todos los Eventos</a>
                    </li>
                    <li>
                        <a class="nav-link" href="crear_evento.php"><i
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover ">
                                    ...
                                    <tr class="no-b">
                                        ...
                                        <td>
                                            <a href="panel-page-products-create.html" class="btn-fab btn-fab-sm btn-primary shadow text-white"><i class="icon-pencil"></i></a>
