<!DOCTYPE html>
<!-- saved from url=(0033)https://5dd49506d2def.site123.me/ -->
<html dir="ltr" lang="es"
	class="home_page home_page_design s_layout13 isFreePackage  js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface no-generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths parallax-active">
...
<head>
	...
	<link rel="manifest" href="https://cdn-cms-s.f-static.com/versions/2/css/manifest.json?w=&amp;orderScreen=&amp;websiteID=2821297&amp;onlyContent=&amp;tranW=&amp;v=y5848_12921968&amp;wd=5dd49506d2def.site123.me">
	<!-- Status Bar -->
	...
	<title class="s123-js-pjax">TiCkeT</title>
	...
	<script async="" src="TiCkeT_files/js/js(1)"></script>
	<script>      window.dataLayer = window.dataLayer || [];
		function gtag() { dataLayer.push(arguments); }
		gtag('js', new Date());
		gtag('config', 'UA-71219427-1');
	</script> <!-- Facebook Meta Info -->
...
<body id="page-top" data-aos-easing="ease" data-aos-duration="200" data-aos-delay="0">
	...
	<div class="body">
		...
		<div id="s123PjaxMainContainer">
			<section id="top-section"
				class="homepage_style_1 top_magic_homepage_kind_1  parallax-on old_homepage_layout_log30 old_homepage_layout_structure_log30">
				<div class="home_background_wrapper parallax-on">
					<div class="parallax-window home-image-bg" data-parallax="scroll" data-bleed="0"
						data-idele="parallax_home_opacity" data-opacity="0.7"
						data-filter="contrast(110%) brightness(110%) saturate(130%)" data-backgroundcolor="#000000"
						data-image-src="TiCkeT_files/2000_5ac9e89bc6d23.jpg"
					...
					<div class="home_main_wrapper main_ele_place_bottom simple_object_position_center_center">
						<div class="box_container">
							<div class="boxBorder  ele_align_center">
								<h1 id="home_siteSlogan" class=" weight400    0 10">Eventos</h1>
								<h2 id="home_siteSlogan_2" class=" weight700    0 10">Universidad Privada Domingo Savio</h2>
							</div>
							<div class="homepage_goal space_from_bottom_mainGoal ele_align_center"
								style="position: relative;max-width: 100%;">
								<div class="promoButtons align_center"><a id="home_buttonText"
										onclick="MoveFirstSection(1);" class="btn btn-primary btn-xl "><span
											class="h-b-container"><span class="h-b-t">Ver Eventos</span></span></a><a id="home_buttonText_1"
										onclick="MoveFirstSection();" class="btn btn-primary btn-xl "
										style="display:none"><span class="h-b-container"><span
												class="h-b-t"></span></span></a></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div id="s123ModulesContainer" class="s123-modules-container">
				<section id="section-5ac9e99f21623" class="s123-module s123-module-events layout-2 bg-primary">
					<div data-aos="fade-up" class="container-fluid page_header_style page_header_style_ aos-init">
						<div class="row">
							<div class="container">
								<div class="row modulesTitle">
									<div class="col-xs-12 text-center">
										<h2 id="section-5ac9e99f21623-title" class="s123-page-header">Eventos</h2>
										<hr class="small">
										<h4 id="section-5ac9e99f21623-slogan"></h4>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="col-sm-4 col-md-3" style="display:none;">
									<div class="categories-panel">
										<div class="well box-primary">
											<ul class="nav events-categories-container">
												<li data-categories-filter="prgggiC3gggiB3ximos-eventos" class="active">
													<a href="">Próximos eventos</a>
												</li>
											</ul>
										</div>
									</div>
									<p class="events-responsive-filter"> <a
											href="">Filtro</a> </p>
								</div>
								<div class="col-xs-12">
									<div class="events-container row row-flex">
										<div data-event-filter="prgggiC3gggiB3ximos-eventos"
											class="col-xs-6 col-sm-4 col-md-3 padding-bottom-2" style="display: block;">
											<div class="box box-primary s123-box-border"> <a
				...
				<section id="section-5ac9f29d7e7a0" class="s123-module s123-module-about layout-2 layout-2 bg-primary">
					<div data-aos="fade-up" class="container-fluid page_header_style page_header_style_ aos-init">
						<div class="row">
							<div class="container">
								<div class="row modulesTitle">
						...
						<div class="row sides">
							<div class="col-xs-12 col-md-6">
								<div class="responsive-handler fr-view breakable">The About page is the core description
									of your website. Here is where you let clients know what your website is
									about.<br><br>You can edit all of this text and replace it with what you want to
									write. For example you can let them know how long you have been in business, what
									makes your company special, what are its core values and more.<br><br>Edit your
									About page from the Pages tab by clicking the edit button.<br><br>You can edit all
							...
							<div class="col-xs-12 col-md-6">
								<div class="separateImages text-center"> <img
										src="./TiCkeT_files/img/800_filter_boost_5ac9f2e4bd483.jpg"
										class="img-rounded img-responsive"
										style="max-height:400px;max-width:80%;display:inline-block;"
										alt="About The Festival"> </div>
							</div>
						</div>
					</div>
				</section>
				...
				<div class="social-icons">
					<ul class="list-inline">
						...
						<li class="visible-xs-inline-block"><a
								...
								target="_blank"><img src="TiCkeT_files/imgmoovit_white_small.png"
									style="width: 40px;height: auto;padding-bottom: 7px;"></a></li>
				...
				<div class="social-details-container social-icons">
					<ul class="list-inline">
						<li><a href="https://www.facebook.com/" target="_blank"><i
									class="fa fa-facebook fa-4x"></i></a></li>
	...
	<!-- Minimize JS files -->
	<script src="./TiCkeT_files/js/minimize.js.descarga" crossorigin="anonymous"></script> <!-- Website Statistics -->
	<script type="text/javascript" src="./TiCkeT_files/js/generateStats.js.descarga" crossorigin="anonymous"></script>
	<!-- Pjax Helper -->
